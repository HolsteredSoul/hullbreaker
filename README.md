...
- **Campaign:** three lives and a basic one-hit hull. Collect shields and hull upgrades to survive additional hits; hull damage drops weapon power. Death resets power and durability, with a protected replacement. Current weapons, hull, shields, pulses, score and lives carry between levels. The last death ends the run.
...
- **Pickups:** red V / blue L / violet M select Vulcan / Lance / Seeker; matching crates increase power, switching resets it to one. Green P upgrades and recharges 24 seconds of boosted fire. Cyan S adds a shield hit (cap two), gold H upgrades and repairs hull (cap three), orange B restores a pulse. Full supplies convert to score. Base weapons always have unlimited fire. Mobile uses compact instruments and letter-coded pickups; the full guide is in pause.
